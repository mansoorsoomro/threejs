                ...
                <div className={`px-4 py-3 space-y-3 ${activeSection === 'openWall' ? 'bg-cream-50' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${openWall === 'Yes' ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                  ...
                  {openWall === 'Yes' && (
                    <>
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">Open Side Wall A</span>
                        <select
                          value={openSideWallA}
                          onChange={e => updateOpenWalls('sideWallA', e.target.value === 'Yes')}
                          className={`w-full px-3 py-2 border rounded-md text-sm ${openSideWallA === 'Yes' ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          <option value="No">No</option>
                          <option value="Yes">Yes</option>
                      ...
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">Open Side Wall B</span>
                        <select
                          value={openSideWallB}
                          onChange={e => updateOpenWalls('sideWallB', e.target.value === 'Yes')}
                          className={`w-full px-3 py-2 border rounded-md text-sm ${openSideWallB === 'Yes' ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          <option value="No">No</option>
                          <option value="Yes">Yes</option>
                      ...
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">Open End Wall C</span>
                        <select
                          value={openEndWallC}
                          onChange={e => updateOpenWalls('endWallC', e.target.value === 'Yes')}
                          className={`w-full px-3 py-2 border rounded-md text-sm ${openEndWallC === 'Yes' ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          <option value="No">No</option>
                          <option value="Yes">Yes</option>
                      ...
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">Open End Wall D</span>
                        <select
                          value={openEndWallD}
                          onChange={e => updateOpenWalls('endWallD', e.target.value === 'Yes')}
                          className={`w-full px-3 py-2 border rounded-md text-sm ${openEndWallD === 'Yes' ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          <option value="No">No</option>
                          <option value="Yes">Yes</option>
                      ...
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">Remove every other post</span>
                        <select
                          value={removeEveryOtherPost}
                          onChange={e => updateOpenWalls('removeEveryOtherPost', e.target.value === 'Yes')}
                          className={`w-full px-3 py-2 border rounded-md text-sm ${removeEveryOtherPost === 'Yes' ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          <option value="No">No</option>
                          <option value="Yes">Yes</option>
                ...
                <div className={`px-4 py-3 space-y-3 ${activeSection === 'gableAccent' ? 'bg-cream-50' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${gableAccent === 'Yes' ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="No">No</option>
                      <option value="Yes">Yes</option>
                  ...
                  {gableAccent === 'Yes' && (
                    <>
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">End Wall C</span>
                        <select
                          ...
                          className={`w-full px-3 py-2 border rounded-md text-sm ${gableAccentEndWallC === 'Yes' ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          <option value="No">No</option>
                          <option value="Yes">Yes</option>
                      ...
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">End Wall D</span>
                        <select
                          ...
                          className={`w-full px-3 py-2 border rounded-md text-sm ${gableAccentEndWallD === 'Yes' ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          <option value="No">No</option>
                          <option value="Yes">Yes</option>
                      ...
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">Choose gable accent color</span>
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className={`flex-1 px-3 py-2 border rounded-md text-sm text-left ${gableAccentColor ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                              }`}
                          >
                ...
                <div className={`px-4 py-3 space-y-3 ${activeSection === 'wainscot' ? 'bg-cream-50' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${wainscot ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="No">No</option>
                      <option value="Yes">Yes</option>
                  ...
                  {wainscot === 'Yes' && (
                    <>
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">Side Wall A</span>
                        <select
                          ...
                          className={`w-full px-3 py-2 border rounded-md text-sm ${wainscotSideWallA ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          <option value="No">No</option>
                          <option value="Yes">Yes</option>
                      ...
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">Side Wall B</span>
                        <select
                          ...
                          className={`w-full px-3 py-2 border rounded-md text-sm ${wainscotSideWallB ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          <option value="No">No</option>
                          <option value="Yes">Yes</option>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className={`w-full px-3 py-2 border rounded-md text-sm ${wainscotEndWallC ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          <option value="No">No</option>
                          <option value="Yes">Yes</option>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className={`w-full px-3 py-2 border rounded-md text-sm ${wainscotEndWallD ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          <option value="No">No</option>
                          <option value="Yes">Yes</option>
                      ...
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">Choose wainscot size</span>
                        <select
                          value={wainscotSize}
                          onChange={e => {
                            const val = e.target.value;
                          ...
                          className={`w-full px-3 py-2 border rounded-md text-sm ${wainscotSize ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                      ...
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">Choose wainscot color</span>
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() => {
                            ...
                            className={`flex-1 px-3 py-2 border rounded-md text-sm text-left ${wainscotColor ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                              }`}
                          >
                ...
                <div className={`px-4 py-4 ${activeSection === 'wallInsulation' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${wallInsulation ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                ...
                <div className={`px-4 py-4 ${activeSection === 'wallCondensation' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${wallCondensation ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="None">None</option>
                ...
                <div className={`px-4 py-4 ${activeSection === 'interiorWallLiner' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${interiorWallLiner && interiorWallLiner !== 'None' ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="None">None</option>
                    ...
                    {interiorWallLiner && interiorWallLiner !== 'None' && (
                      <div className="mt-3">
                        <p className="text-xs text-brown-700 mb-1">Select liner color</p>
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() => {
                            ...
                            className="flex-1 px-3 py-2 text-left border rounded-md text-sm bg-white hover:bg-cream-200 flex items-center justify-between group"
                          >
                            <span>
                              {trimColors.find(c => c.value === interiorWallLinerColor)?.label || 'Select color'}
                            </span>
                            <span className="text-brown-400 group-hover:text-brown-500">▼</span>
                          </button>
                          <button
                            onClick={() => {
                              setSelectedColorForModal(interiorWallLinerColor || '');
                ...
                <div className={`px-4 py-4 ${activeSection === 'roofCondensation' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${roofCondensation ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="None">None</option>
                ...
                <div className={`px-4 py-4 ${activeSection === 'ceilingInsulation' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${ceilingInsulation ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="None">None</option>
                ...
                <div className={`px-4 py-4 ${activeSection === 'ceilingLiner' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${ceilingLiner && ceilingLiner !== 'None' ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="None">None</option>
                      <option value="ProRib">ProRib</option>
                ...
                <div className={`px-4 py-4 ${activeSection === 'ridgeOptions' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${ridgeOptions ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                ...
                <div className={`px-4 py-4 ${activeSection === 'outsideClosure' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${outsideClosure ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
              ...
              >
                <div className={`px-4 py-4 ${activeSection === 'ridgeVentilation' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <p className="text-xs text-brown-700 mb-3">Select quantity of ridge vents</p>
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${ridgeVentilation ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
              ...
              >
                <div className={`px-4 py-4 ${activeSection === 'gableVents' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <p className={`text-xs mb-2 italic ${currentDesign.roofColor === 'galvanized' ? 'text-red-600' : 'text-brown-500'}`}>This option cannot be changed when Steel Roof Panels option Galvanized is chosen</p>
                    <p className="text-xs text-brown-700 mb-3">Select type of gable vents</p>
                    <select
                      value={gableVents}
                      onChange={e => {
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${gableVents ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                      disabled={currentDesign.roofColor === 'galvanized'}
                    >
                      <option value="None">None</option>
                ...
                <div className={`px-4 py-4 ${activeSection === 'endCaps' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${endCaps ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="No">No</option>
                      <option value="Yes">Yes</option>
                ...
                <div className={`px-4 py-4 ${activeSection === 'snowGuards' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${snowGuards ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="No">No</option>
                      <option value="Yes">Yes</option>
                ...
                <div className={`px-4 py-4 ${activeSection === 'skylights' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${skylights ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="None">None</option>
                    ...
                    {skylights !== 'None' && (
                      <div className="mt-3">
                        <p className="text-xs text-brown-700 mb-1">Select quantity</p>
                        <select
                ...
                <div className={`px-4 py-3 space-y-3 ${activeSection === 'eaveLight' ? 'bg-cream-50' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${eaveLightA ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="None">None</option>
                  ...
                  <div>
                    <span className="text-xs text-brown-700 block mb-2">Sidewall B eavelight</span>
                    <select
                      value={eaveLightB}
                      onChange={e => {
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${eaveLightB ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="None">None</option>
                      <option value="2ft">2ft</option>
              ...
              >
                <div className={`px-4 py-4 ${activeSection === 'gutters' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <p className="text-xs text-brown-700 mb-3">Add gutters</p>
                    <select
                      value={gutters}
                      onChange={e => {
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${gutters ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    ...
                    {gutters === 'Yes' && (
                      <div className="mt-3">
                        <p className="text-xs text-brown-700 mb-1">Select gutter color</p>
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() => {
              ...
              >
                <div className={`px-4 py-4 ${activeSection === 'cupolas' ? 'bg-cream-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <p className="text-xs text-brown-700 mb-3">Select the size of cupolas</p>
                    <select
                      value={cupolas}
                      onChange={e => {
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${cupolas ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                      <option value="None">None</option>
              ...
              {infoTab === 'information' && (
                <>
                    ...
                    <div className="mb-4 p-3 border border-cream-300 rounded-lg bg-cream-200">
                      ...
                      <div className="flex flex-col gap-1">
                        <div>
                          ...
                          <span className="text-lg font-bold text-brown-900 align-baseline">
                  ...
                  {activeSection === 'openWall' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Open Wall</h3>
                      <div className="mb-4">
                        <img
                  ...
                  {activeSection === 'gableAccent' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Gable Accent</h3>
                      <div className="mb-4">
                        <img
                      ...
                      <ul className="space-y-2 text-sm text-brown-700 list-disc list-inside mb-4">
                  ...
                  {activeSection === 'wainscot' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Wainscot</h3>
                      <div className="mb-4">
                        <img
                  ...
                  {activeSection === 'wallInsulation' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Wall Insulation</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          ...
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">EcoBatt</h4>
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Roll</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                            <li>Insulation saves on heating and cooling costs and helps reduce noise</li>
                  ...
                  {activeSection === 'wallCondensation' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Wall Condensation Control</h3>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Kimberly-Clark Block It House Wrap</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Reflectix Bubble Insulation</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Pro-Therm Condensation Blanket</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                  ...
                  {activeSection === 'interiorWallLiner' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Interior Wall Liner</h3>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                        {/* Pro Rib Panel */}
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Pro Rib</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Dura Panel</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                            <li>Most economical</li>
                            <li>Lightweight</li>
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Acoustical Panel</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                  ...
                  {activeSection === 'roofCondensation' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Roof Condensation Control</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                        {/* Reflectix Bubble Insulation Panel */}
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                  ...
                  {activeSection === 'ceilingInsulation' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Ceiling Insulation</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                        {/* Blow-In Panel */}
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Blow-In</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Batt</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                  ...
                  {activeSection === 'ceilingLiner' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Ceiling Liner</h3>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                        {/* Pro Rib Panel */}
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                  ...
                  {activeSection === 'ridgeOptions' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Ridge Options</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Universal</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Pro-Sky</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                  ...
                  {activeSection === 'outsideClosure' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Outside Closure Strip</h3>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Standard Non-Vented</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Economy Vented</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Premium Vented</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                  ...
                  {activeSection === 'ridgeVentilation' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Ridge Ventilation</h3>
                      <div className="mb-4">
                        <img
                  ...
                  {activeSection === 'gableVents' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Gable Vents</h3>
                      <div className="mb-4">
                        <img
                  ...
                  {activeSection === 'endCaps' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">End Caps</h3>
                      <div className="mb-4">
                        <img
                  ...
                  {activeSection === 'snowGuards' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Snow Guards</h3>
                      <div className="mb-4">
                        <img
                  ...
                  {activeSection === 'skylights' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Skylights</h3>
                      <div className="mb-4">
                        <img
                  ...
                  {activeSection === 'eaveLight' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Eave Light</h3>
                      <div className="mb-4">
                        <img
                  ...
                  {activeSection === 'gutters' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3 text-center">Gutters</h3>
                      <div className="mb-4">
                        <img
                  ...
                  {activeSection === 'cupolas' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3 text-center">Cupolas</h3>
                      <div className="mb-4">
                        <img
                  ...
                  {activeSection !== 'openWall' && activeSection !== 'gableAccent' && activeSection !== 'wainscot' && activeSection !== 'wallInsulation' && activeSection !== 'wallCondensation' && activeSection !== 'interiorWallLiner' && activeSection !== 'roofCondensation' && activeSection !== 'ceilingInsulation' && activeSection !== 'ceilingLiner' && activeSection !== 'ridgeOptions' && activeSection !== 'outsideClosure' && activeSection !== 'ridgeVentilation' && activeSection !== 'gableVents' && activeSection !== 'endCaps' && activeSection !== 'snowGuards' && activeSection !== 'skylights' && activeSection !== 'eaveLight' && activeSection !== 'gutters' && activeSection !== 'cupolas' && (
                    <div className="mb-4">
                      {(() => {
                        ...
                        return <h3 className="text-base font-bold text-brown-900 mb-3">{label}</h3>;
                      })()}
