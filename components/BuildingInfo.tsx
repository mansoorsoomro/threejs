                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className={`flex-1 px-3 py-2 border rounded-md text-sm text-left ${currentDesign.soffitColor ? 'border-blue-500 bg-blue-50' : 'border-gray-300 bg-white'
                              }`}
                          >
                  ...
                  {activeSection === 'fascia' && (
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        {/* 4" Fascia */}
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.fasciaSize === '4' ? 'border-green-600 ring-2 ring-green-100' : 'border-gray-300 hover:border-gray-400'
                            }`}
                        ...
                        {/* 6" Fascia */}
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.fasciaSize === '6' ? 'border-green-600 ring-2 ring-green-100' : 'border-gray-300 hover:border-gray-400'
                            }`}
                  ...
                  {activeSection === 'fastenerPlacement' && (
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        {/* Screws in the Flat */}
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.fastenerLocation === 'Wall & Roof' ? 'border-green-600 ring-2 ring-green-100' : 'border-gray-300 hover:border-gray-400'
                            }`}
                        ...
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.fastenerLocation === 'Roof Only' ? 'border-green-600 ring-2 ring-green-100' : 'border-gray-300 hover:border-gray-400'
                            }`}
                  ...
                  {activeSection === 'plans' && (
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        {/* Hard Copy and Email */}
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.miniPrintOption === 'Premium' ? 'border-green-600 ring-2 ring-green-100' : 'border-gray-300 hover:border-gray-400'
                            }`}
                        ...
                        {/* Email */}
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.miniPrintOption === 'Standard' ? 'border-green-600 ring-2 ring-green-100' : 'border-gray-300 hover:border-gray-400'
                            }`}
