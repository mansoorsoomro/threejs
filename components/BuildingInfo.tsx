    ...
    <div className="min-h-screen bg-cream-200 overflow-auto pb-20">
      <div className="w-full h-full p-2 md:p-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 md:gap-[10px] min-h-screen">
                ...
                <div className={`px-4 py-4 ${activeSection === 'floor' ? 'bg-yellow-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${currentDesign.floorFinish ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                  ...
                  {currentDesign.floorFinish === 'concrete' && (
                    <div className="mt-4">
                      <p className="text-xs font-semibold text-brown-900 mb-1">Choose the floor thickness</p>
                      <select
                      ...
                      <p className="mt-2 text-xs italic text-brown-800">
                ...
                <div className={`px-4 py-4 ${activeSection === 'sidewallPosts' ? 'bg-yellow-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${currentDesign.sidewallPosts ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                ...
                <div className={`px-4 py-4 ${activeSection === 'postFoundation' ? 'bg-yellow-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${postFoundation ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                  ...
                  <div className={`px-4 py-3 space-y-3 ${activeSection === 'postEmbedment' ? 'bg-yellow-50' : 'bg-transparent'}`}>
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full px-3 py-2 border rounded-md text-sm ${postEmbedmentDepth ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                          }`}
                      >
                    ...
                    <div>
                      <span className="text-xs text-brown-700 block mb-2">Select footing size</span>
                      <select
                        value={footingSize}
                        onChange={e => {
                        ...
                        className={`w-full px-3 py-2 border rounded-md text-sm ${footingSize ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                          }`}
                      >
                ...
                <div className={`px-4 py-4 ${activeSection === 'gradeboard' ? 'bg-yellow-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${currentDesign.gradeBoard ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                ...
                {(currentDesign.gradeBoard === '2x6-centermatch' || currentDesign.gradeBoard === '2x6-fusion-centermatch') && (
                  <div className="mt-4 space-y-3 pt-3 border-t border-yellow-300/50">
                    {[
                      ...
                      <div key={field.key}>
                        <span className="text-xs text-brown-700 block mb-2">{field.label}</span>
                        <select
                          ...
                          className="w-full px-3 py-2 border rounded-md text-sm border-cream-300 bg-white"
                        >
                ...
                <div className={`px-4 py-4 ${activeSection === 'girtType' ? 'bg-yellow-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${currentDesign.girtType ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                ...
                <div className={`px-4 py-4 ${activeSection === 'girtSize' ? 'bg-yellow-200' : 'bg-transparent'}`}>
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-2 border rounded-md text-sm ${girtSize ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                        }`}
                    >
                  ...
                  <div className={`px-4 py-3 space-y-3 ${activeSection === 'steelWall' ? 'bg-yellow-50' : 'bg-transparent'}`}>
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full px-3 py-2 border rounded-md text-sm ${wallPanelType ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                          }`}
                      >
                    ...
                    <div>
                      <span className="text-xs text-brown-700 block mb-2">Choose wall color</span>
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className={`flex-1 px-3 py-2 border rounded-md text-sm text-left ${currentDesign.wallColor ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                          {wallColors.find(c => c.value === currentDesign.wallColor)?.label || 'Select color'}
                        </button>
                        <div
                          className="w-10 h-10 border border-cream-300 rounded"
                          style={{
                  ...
                  <div className={`px-4 py-3 space-y-3 ${activeSection === 'steelRoof' ? 'bg-yellow-50' : 'bg-transparent'}`}>
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full px-3 py-2 border rounded-md text-sm ${roofPanelType ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                          }`}
                      >
                        <option value="Pro-Rib">Pro-Rib</option>
                        <option value="Premium Pro-Rib">Premium Pro-Rib</option>
                    ...
                    <div>
                      <span className="text-xs text-brown-700 block mb-2">Choose roof color</span>
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => {
                          ...
                          className={`flex-1 px-3 py-2 border rounded-md text-sm text-left ${currentDesign.roofColor ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className={`flex-1 px-3 py-2 border rounded-md text-sm text-left ${currentDesign.trimColor ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className="w-10 h-10 border border-cream-300 rounded cursor-pointer"
                          style={{
                  ...
                  <div className={`px-4 py-3 space-y-3 ${activeSection === 'overhangs' ? 'bg-yellow-50' : 'bg-transparent'}`}>
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full px-3 py-2 border rounded-md text-sm ${currentDesign.endWallOverhang ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                          }`}
                      >
                    ...
                    <div>
                      <span className="text-xs text-brown-700 block mb-2">Sidewall overhang length</span>
                      <select
                        ...
                        className={`w-full px-3 py-2 border rounded-md text-sm ${currentDesign.sidewallOverhang ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                          }`}
                      >
                        <option value="0">0ft</option>
                        <option value="1">1ft</option>
                    ...
                    {(currentDesign.endWallOverhang !== '0' || currentDesign.sidewallOverhang !== '0') && (
                      <div>
                        <span className="text-xs text-brown-700 block mb-2">Choose soffit color</span>
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() => {
                              setSelectedColorForModal(currentDesign.soffitColor || 'white');
                              setShowSoffitColorModal(true);
                            }}
                            className={`flex-1 px-3 py-2 border rounded-md text-sm text-left ${currentDesign.soffitColor ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                              }`}
                          >
                            {trimColors.find(c => c.value === (currentDesign.soffitColor || 'white'))?.label || 'Select color'}
                          </button>
                          <button
                            onClick={() => {
                              setSelectedColorForModal(currentDesign.soffitColor || 'white');
                            ...
                            className="w-10 h-10 border border-cream-300 rounded cursor-pointer"
                            style={{
                              backgroundColor: trimColors.find(c => c.value === (currentDesign.soffitColor || 'white'))?.hex || '#808080'
                            }}
                          />
                        </div>
                      </div>
                  ...
                  <div className={`px-4 py-3 space-y-3 ${activeSection === 'fascia' ? 'bg-yellow-50' : 'bg-transparent'}`}>
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full px-3 py-2 border rounded-md text-sm ${fasciaSize ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                          }`}
                      >
                  ...
                  <div className={`px-4 py-3 space-y-3 ${activeSection === 'fastenerPlacement' ? 'bg-yellow-50' : 'bg-transparent'}`}>
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full px-3 py-2 border rounded-md text-sm ${wallFastenerLocation ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                          }`}
                      >
                    ...
                    <div>
                      <span className="text-xs text-brown-700 block mb-2">Roof fastener location</span>
                      <select
                        value={roofFastenerLocation}
                        onChange={e => setRoofFastenerLocation(e.target.value)}
                        className={`w-full px-3 py-2 border rounded-md text-sm ${roofFastenerLocation ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                          }`}
                      >
                        <option value="In the Flat">In the Flat</option>
                        <option value="On the Rib">On the Rib</option>
                  ...
                  <div className={`px-4 py-4 ${activeSection === 'plans' ? 'bg-yellow-200' : 'bg-transparent'}`}>
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full px-3 py-2 border rounded-md text-sm ${plansOption ? 'border-blue-500 bg-blue-50' : 'border-cream-300 bg-white'
                          }`}
                      >
          ...
          {/* Right Side - Information and 3D Tabs */}
          <div className="bg-white rounded-lg shadow-md p-3 md:p-4 lg:col-span-8 flex flex-col max-h-[60vh] lg:max-h-full lg:h-full overflow-hidden order-1 lg:order-2">
            <div className="mb-2 md:mb-3 flex-shrink-0">
              <div className="flex space-x-2 border-b">
                <button
                  ...
                  className={`px-2 md:px-3 py-1.5 font-semibold rounded-t transition-colors text-xs md:text-sm ${infoTab === 'information'
                ...
                <button
                  ...
                  className={`px-2 md:px-3 py-1.5 font-semibold rounded-t transition-colors text-xs md:text-sm ${infoTab === '3d'
                    ? 'bg-brown-600 text-white'
                    : 'bg-cream-400 text-brown-700 hover:bg-gray-300'
                    }`}
                >
            ...
            <div className="flex-1 overflow-y-auto">
              {infoTab === 'information' && (
                <>
                  ...
                  {activeSection === 'floor' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Floor</h3>
                      <div className="mb-4">
                        <img
                          src="/assets/floor.jpg"
                          alt="Floor type illustration"
                          className="w-full h-auto max-h-96 object-contain rounded border border-cream-300 mb-4"
                        />
                  ...
                  {activeSection === 'sidewallPosts' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Sidewall Posts</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        {/* Treated Posts Panel */}
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            src="/assets/post.jpg"
                            alt="Treated Posts"
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Treated Posts</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                            <li>4x6 &amp; 6x6</li>
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Laminated Columns</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                  ...
                  {activeSection === 'postFoundation' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Post Foundation</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        {/* Post Embedded Panel */}
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Post Embedded</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Secured To Concrete</h4>
                          <ul className="text-sm text-brown-700 space-y-2 list-disc list-inside">
                  ...
                  {activeSection === 'postEmbedment' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Post Embedment</h3>

                      {/* All three images in one row */}
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        {/* Footing Pad Size Guidelines */}
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">FOOTING PAD SIZE GUIDELINES</h4>
                          <img
                            src="/assets/post_foundationV2.jpg"
                            alt="Post Embedment - Footing Pad Size Guidelines"
                            className="w-full h-auto max-h-48 object-contain rounded border border-cream-300 mb-4"
                          />
                        ...
                        {/* Precast Footing Pad */}
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Precast Footing Pad</h4>
                          <img
                            src="/assets/precast-footing-pad.png"
                            alt="Precast Footing Pad"
                            className="w-full h-auto max-h-48 object-contain rounded border border-cream-300 mb-4"
                          />
                          <ul className="text-xs text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        {/* Poured Footing Pad */}
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Poured Footing Pad</h4>
                          <img
                  ...
                  {activeSection === 'gradeboard' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Gradeboard</h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-48 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Treated Gradeboard</h4>
                          <ul className="text-xs text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-48 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Treated Centermatch</h4>
                          <ul className="text-xs text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-48 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Fusion Gradeboard</h4>
                          <ul className="text-xs text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-48 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Fusion Centermatch</h4>
                          <ul className="text-xs text-brown-700 space-y-2 list-disc list-inside">
                            <li>Encapsulated surface technology for the best fade, scratch and stain resistance available for UltraDeck® products</li>
                            <li>Can be stacked for a taller gradeboard option which allows for vertical grade elevation on post frame buildings</li>
                          </ul>
                  ...
                  {activeSection === 'girtType' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Girt Type</h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-48 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Flat Girts</h4>
                          <ul className="text-xs text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-48 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Bookshelf Girts</h4>
                          <ul className="text-xs text-brown-700 space-y-2 list-disc list-inside">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-48 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Double Girts</h4>
                          <ul className="text-xs text-brown-700 space-y-2 list-disc list-inside">
                  ...
                  {activeSection === 'girtSize' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Girt Size</h3>
                      <div className="mb-4">
                        <img
                  ...
                  {activeSection === 'steelWall' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Steel Wall Panels</h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Steel Panel Options</h4>
                          <div className="space-y-3 text-sm text-brown-700">
                            <div>
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Designer Steel Series</h4>
                          <div className="space-y-2 text-sm text-brown-700">
                            <p>
                        ...
                        <div className="border-2 border-cream-300 rounded-lg p-3 bg-white">
                          <img
                            ...
                            className="w-full h-auto max-h-64 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Woodgrain Steel Series</h4>
                          <div className="space-y-2 text-sm text-brown-700">
                            <p>
                  ...
                  {activeSection === 'steelRoof' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Steel Roof Panels</h3>
                  ...
                  {activeSection === 'trimColor' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Trim Color</h3>
                      <div className="border border-cream-300 rounded-lg p-4 bg-white">
                        <ul className="space-y-2 text-sm text-brown-700 list-disc list-inside">
                  ...
                  {activeSection === 'overhangs' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Overhangs</h3>
                      <div className="border border-cream-300 rounded-lg p-4 bg-white mb-4">
                        <img
                          src="/assets/with_ohV2.png"
                          alt="Building with Overhang"
                          className="w-full h-auto max-h-96 object-contain rounded border border-cream-300 mb-4"
                        />
                        <h4 className="text-sm font-bold text-brown-900 mb-2 text-center">Building with Overhang</h4>
                        <ul className="space-y-2 text-sm text-brown-700 list-disc list-inside">
                  ...
                  {activeSection === 'fascia' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Fascia</h3>

                      {/* Two images in one row with text below */}
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        {/* 4" Fascia */}
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.fasciaSize === '4' ? 'border-brown-600 ring-2 ring-green-100' : 'border-cream-300 hover:border-gray-400'
                            }`}
                          onClick={() => handleDesignChange({ fasciaSize: '4' })}
                        >
                          <img
                            ...
                            className="w-full h-auto max-h-96 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">4&quot; Fascia</h4>
                          <ul className="space-y-2 text-sm text-brown-700 list-disc list-inside">
                        ...
                        {/* 6" Fascia */}
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.fasciaSize === '6' ? 'border-brown-600 ring-2 ring-green-100' : 'border-cream-300 hover:border-gray-400'
                            }`}
                          onClick={() => handleDesignChange({ fasciaSize: '6' })}
                        >
                          <img
                            ...
                            className="w-full h-auto max-h-96 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">6&quot; Fascia</h4>
                          <ul className="space-y-2 text-sm text-brown-700 list-disc list-inside">
                  ...
                  {activeSection === 'fastenerPlacement' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Fastener Placement</h3>

                      {/* Two images in one row with text below */}
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        {/* Screws in the Flat */}
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.fastenerLocation === 'Wall & Roof' ? 'border-brown-600 ring-2 ring-green-100' : 'border-cream-300 hover:border-gray-400'
                            }`}
                          onClick={() => handleDesignChange({ fastenerLocation: 'Wall & Roof' })}
                        >
                          <img
                            ...
                            className="w-full h-auto max-h-96 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Fastener Placement - Screws in the flat</h4>
                          <ul className="space-y-2 text-sm text-brown-700 list-disc list-inside">
                        ...
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.fastenerLocation === 'Roof Only' ? 'border-brown-600 ring-2 ring-green-100' : 'border-cream-300 hover:border-gray-400'
                            }`}
                          onClick={() => handleDesignChange({ fastenerLocation: 'Roof Only' })}
                        >
                          <img
                            ...
                            className="w-full h-auto max-h-96 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Fastener Placement - Screws through the rib</h4>
                          <ul className="space-y-2 text-sm text-brown-700 list-disc list-inside">
                  ...
                  {activeSection === 'plans' && (
                    <div className="mb-4">
                      <h3 className="text-base font-bold text-brown-900 mb-3">Plans</h3>

                      {/* Two images in one row with text below */}
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        {/* Hard Copy and Email */}
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.miniPrintOption === 'Premium' ? 'border-brown-600 ring-2 ring-green-100' : 'border-cream-300 hover:border-gray-400'
                            }`}
                          onClick={() => handleDesignChange({ miniPrintOption: 'Premium' })}
                        >
                          <img
                            ...
                            className="w-full h-auto max-h-96 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Hard Copy and Email</h4>
                          <ul className="space-y-2 text-sm text-brown-700 list-disc list-inside">
                        ...
                        {/* Email */}
                        <div
                          className={`border-2 rounded-lg p-3 bg-white cursor-pointer transition-all ${currentDesign.miniPrintOption === 'Standard' ? 'border-brown-600 ring-2 ring-green-100' : 'border-cream-300 hover:border-gray-400'
                            }`}
                          onClick={() => handleDesignChange({ miniPrintOption: 'Standard' })}
                        >
                          <img
                            ...
                            className="w-full h-auto max-h-96 object-contain rounded border border-cream-300 mb-4"
                          />
                          <h4 className="text-sm font-semibold text-brown-900 mb-2 text-center">Email</h4>
                          <ul className="space-y-2 text-sm text-brown-700 list-disc list-inside">
                ...
                <div className="h-full">
                  <Building3D
                    design={{
                      ...
                      // Use preview soffit color if modal is open and color is selected
                      soffitColor: (showSoffitColorModal && selectedColorForModal)
                        ? (selectedColorForModal === 'galvanized' ? 'ash-gray' :
                          selectedColorForModal === 'rough-sawn-natural-cedar' || selectedColorForModal === 'rough-sawn-gray-cedar'
                            ? (selectedColorForModal === 'rough-sawn-natural-cedar' ? 'tan' : 'ash-gray')
                            : selectedColorForModal)
                        : (currentDesign.soffitColor || 'white'),
            ...
            <Footer
              ...
              continueLabel="Next: Accessories"
            />
          </div>
        </div>
      </div>
      ...
      <>
        ...
        {showWallColorModal && (
          <div className="fixed left-0 top-0 h-full w-[350px] z-50 transform transition-transform duration-300 ease-in-out translate-x-0" onClick={(e) => e.stopPropagation()}>
            <div className="bg-white h-full shadow-2xl border-r border-cream-300 flex flex-col relative" onClick={(e) => e.stopPropagation()}>
              {/* Green Banner */}
              <div className="bg-brown-600 text-white px-4 py-3 flex items-center justify-between shrink-0">
              ...
              <div className="p-4 border-b border-cream-300 shrink-0 bg-white">
                <h3 className="text-sm font-semibold text-brown-900 mb-2">Current Selection:</h3>
                <p className="text-sm font-bold text-brown-900 mb-3">
                  {selectedColorForModal
                ...
                <div
                  className="w-full h-24 rounded border-2 border-cream-300 mb-4"
                  style={{
                ...
                <button
                  ...
                  className="w-full px-4 py-3 bg-brown-600 text-white rounded-md hover:bg-brown-700 font-semibold transition-colors"
                >
                  Select
                </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-4">
                <div className="space-y-4">
                  {/* Designer Colors */}
                  <div>
                    <h3 className="text-sm font-semibold text-brown-900 mb-3">Designer Colors</h3>
                      ...
                      {wallColors.filter(c => ['dover-gray', 'knights-armor', 'smoky-sable', 'sandy-clay'].includes(c.value)).map(color => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-20 h-20 rounded border-2 transition-all ${selectedColorForModal === color.value ? 'border-brown-600 ring-2 ring-brown-300' : 'border-gray-400 hover:border-gray-500'
                              }`}
                            style={imagePath ? {
                  ...
                  {/* Standard Colors */}
                  <div>
                    <h3 className="text-sm font-semibold text-brown-900 mb-3">Standard Colors</h3>
                      ...
                      {wallColors.filter(c => [
                        ...
                        return (
                          <button
                            key={color.value}
                            onClick={() => setSelectedColorForModal(color.value)}
                            className={`w-14 h-14 rounded border-2 transition-all ${selectedColorForModal === color.value ? 'border-brown-600 ring-2 ring-brown-300' : 'border-gray-400 hover:border-gray-500'
                              }`}
                            style={imagePath ? {
                              backgroundImage: `url(${imagePath})`,
                              backgroundPosition: 'center center',
                  ...
                  {/* Woodgrain Colors */}
                  <div>
                    <h3 className="text-sm font-semibold text-brown-900 mb-3">Woodgrain Colors</h3>
              ...
              <div className="bg-white h-full shadow-2xl border-r border-cream-300 flex flex-col relative" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="p-4 border-b border-cream-300 shrink-0 bg-white">
                  ...
                  <p className="text-sm font-bold text-brown-900 mb-3">
                    {selectedColorForModal
                      ? trimColors.find(c => c.value === selectedColorForModal)?.label || 'Select a color'
                      : trimColors.find(c => c.value === (currentDesign.soffitColor || 'white'))?.label || 'Select a color'}
                  </p>
                  <div
                    className="w-full h-24 rounded border-2 border-cream-300 mb-4"
                    style={{
                      backgroundImage: selectedColorForModal
                        ? (getColorImagePath(selectedColorForModal, trimColors.find(c => c.value === selectedColorForModal)?.label || ''))
                          ? `url(${getColorImagePath(selectedColorForModal, trimColors.find(c => c.value === selectedColorForModal)?.label || '')})`
                          : undefined
                        : (getColorImagePath(currentDesign.soffitColor || 'white', trimColors.find(c => c.value === (currentDesign.soffitColor || 'white'))?.label || 'White'))
                          ? `url(${getColorImagePath(currentDesign.soffitColor || 'white', trimColors.find(c => c.value === (currentDesign.soffitColor || 'white'))?.label || 'White')})`
                          : undefined,
                      backgroundPosition: 'center center',
                      backgroundSize: '100% 100%',
                      backgroundOrigin: 'border-box',
                      backgroundColor: selectedColorForModal
                        ? trimColors.find(c => c.value === selectedColorForModal)?.hex || '#FFFFFF'
                        : trimColors.find(c => c.value === (currentDesign.soffitColor || 'white'))?.hex || '#FFFFFF'
                    }}
                  />
                  <button
                    onClick={() => {
                      if (selectedColorForModal) {
                        if (selectedColorForModal === 'galvanized') {
                          handleDesignChange({ soffitColor: 'ash-gray' });
                        } else if (selectedColorForModal === 'rough-sawn-natural-cedar' || selectedColorForModal === 'rough-sawn-gray-cedar') {
                          handleDesignChange({ soffitColor: selectedColorForModal === 'rough-sawn-natural-cedar' ? 'tan' : 'ash-gray' });
                        } else {
                          handleDesignChange({ soffitColor: selectedColorForModal });
                        }
                      } else {
                        handleDesignChange({ soffitColor: currentDesign.soffitColor || 'white' });
                      }
                      setShowSoffitColorModal(false);
                      setSelectedColorForModal('');
                    }}
